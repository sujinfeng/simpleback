      ...
      <el-header>
        <div class="headercls">
          <div class="header-user-con">
            ...
            <div class="logo"><b>智慧杆</b>&nbsp;后台管理系统</div>
            ...
            <el-dropdown class="user-name" trigger="click" @command="handleCommand">
              <span class="el-dropdown-link">
                {{this.$store.state.token}} <i class="el-icon-caret-bottom"></i>
              </span>
...
<script>
  import tags from '@/components/TagsCom.vue';
  import bus from '@/apis/bus.js';
  import Acccls from "../components/AccclsCom";
